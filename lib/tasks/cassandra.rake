namespace :cassandra do
  ...
  task create_tables: :environment do
    ...
    puts "Tables #{entrance_manifests_table}, #{technician_tasks_table}, #{worker_tasks_table}, #{rooms_table}, #{departure_manifests_table}, and #{shipments_table} created successfully in keyspace #{keyspace}."
  end
  ...
  task drop_tables: :environment do
    ...
    drop_technician_tasks_statement = "DROP TABLE IF EXISTS #{keyspace}.#{worker_tasks_table};"
    ...
    puts "Tables #{entrance_manifests_table}, #{technician_tasks_table}, #{worker_tasks_table}, #{rooms_table}, #{departure_manifests_table}, and #{shipments_table} dropped successfully from keyspace #{keyspace}."
  end
